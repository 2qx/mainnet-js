...
```php
    require_once('/path/to/tkMainnetPkg/vendor/autoload.php');
```
...
## Documentation For Models
 ...
 - [Cashaddr](docs/Model/Cashaddr.md)
 ...
 - [Outpoint](docs/Model/Outpoint.md)
 - [RegCashaddr](docs/Model/RegCashaddr.md)
 ...
 - [ToCashaddr](docs/Model/ToCashaddr.md)
