...
class WalletApi
{
     ...
     *
     * @param  \Mainnet\Model\UNKNOWN_BASE_TYPE $unknown_base_type place a send request (required)
     *
     * @throws \Mainnet\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Mainnet\Model\SendResponse
     */
    public function send($unknown_base_type)
    {
        list($response) = $this->sendWithHttpInfo($unknown_base_type);
        return $response;
    }
     ...
     */
    public function sendWithHttpInfo($unknown_base_type)
    {
        $request = $this->sendRequest($unknown_base_type);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendAsync($unknown_base_type)
    {
        return $this->sendAsyncWithHttpInfo($unknown_base_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendAsyncWithHttpInfo($unknown_base_type)
    {
        $returnType = '\Mainnet\Model\SendResponse';
        $request = $this->sendRequest($unknown_base_type);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sendRequest($unknown_base_type)
    {
        // verify the required parameter 'unknown_base_type' is set
        if ($unknown_base_type === null || (is_array($unknown_base_type) && count($unknown_base_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $unknown_base_type when calling send'
            );
        }
