...
$wallet_request = new \Mainnet\Model\WalletRequest(); // \Mainnet\Model\WalletRequest | Request a new new random wallet
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **wallet_request** | [**\Mainnet\Model\WalletRequest**](../Model/WalletRequest.md)| Request a new new random wallet |
...
> \Mainnet\Model\SendResponse send($unknown_base_type)
...
$unknown_base_type = new \Mainnet\Model\UNKNOWN_BASE_TYPE(); // \Mainnet\Model\UNKNOWN_BASE_TYPE | place a send request

try {
    $result = $apiInstance->send($unknown_base_type);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **unknown_base_type** | [**\Mainnet\Model\UNKNOWN_BASE_TYPE**](../Model/UNKNOWN_BASE_TYPE.md)| place a send request |
...
$send_max_request = new \Mainnet\Model\SendMaxRequest(); // \Mainnet\Model\SendMaxRequest | Request to all available funds to a given address
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **send_max_request** | [**\Mainnet\Model\SendMaxRequest**](../Model/SendMaxRequest.md)| Request to all available funds to a given address |
